...
class Listfour2ItemWidget extends StatelessWidget {
  Listfour2ItemWidget(this.listfour2ItemModelObj);

  Listfour2ItemModel listfour2ItemModelObj;

  var controller = Get.find<PerfilMeuEndereOOneController>();
