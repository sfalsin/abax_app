import '../perfil_meu_endere_o_four_screen/widgets/listclock1_item_widget.dart';
import '../perfil_meu_endere_o_four_screen/widgets/listfour1_item_widget.dart';
...
class PerfilMeuEndereOFourScreen
    extends GetWidget<PerfilMeuEndereOFourController> {
  @override
                              ...
                              child: Padding(
                                  ...
                                  child: Obx(() => ListView.builder(
                                      ...
                                      itemCount: controller
                                          ...
                                          .length,
                                      itemBuilder: (context, index) {
                                        Listfour1ItemModel model = controller
                                            .perfilMeuEndereOFourModelObj
                                            .value
                                            .listfour1ItemList[index];
                                        return Listfour1ItemWidget(model);
                                      })))),
                          Padding(
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    Padding(
                                        ...
                                        child: Text(
                                            "msg_solicita_o_em_andamento".tr,
                                            overflow: TextOverflow.ellipsis,
                                            textAlign: TextAlign.left,
                                    ...
                                    Container(
                                        ...
                                        child: Text("msg_recebemos_a_sua".tr,
                                            maxLines: null,
