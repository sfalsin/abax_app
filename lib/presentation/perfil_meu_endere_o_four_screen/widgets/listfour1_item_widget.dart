...
class Listfour1ItemWidget extends StatelessWidget {
  Listfour1ItemWidget(this.listfour1ItemModelObj);

  Listfour1ItemModel listfour1ItemModelObj;

  var controller = Get.find<PerfilMeuEndereOFourController>();
