...
class CouponService {
  ...
  Future<dynamic> getCoupon(String key) async {
    final SigV4Request signedRequest = new SigV4Request(awsSigV4Client, method: 'GET', path: '/freeqr/'+key.replaceAll("http://app.sefaz.es.gov.br/ConsultaNFCe/qrcode.aspx?p=",""));
